    ...
    <div class="tutorial-content container">
        ...
        <div class="first-content">
            ...
            <div class="title-content">
                <p class="text-content">{{ $bulletin->title }}</p>
            </div>
        </div>

        <div class="second-content">
            <h5>Bulletin Description</h5>
            <div class="description-content">
                <div class="desription-text">
                    <p class="text-content">{{ $bulletin->description }}</p>
                </div>
            </div>
        </div>

        {{-- Display uploaded files --}}
        @if (isset($bulletin->files))
        ...
        @if (isset($bulletin->links))
            @foreach ($bulletin->links as $link)
