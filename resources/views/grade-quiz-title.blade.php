...
<head>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="{{ secure_asset('grade-quiz-title.css') }}"> <!-- New CSS file for the container -->
</head>
<body>
    ...
    <div class="container-q">
        @foreach($quizzes as $quiz)
            <div class="container quiz-container">
                <button type="button" class="quiz-button" onclick="window.location.href='{{ route('grade-quiz', ['classId' => $class->id, 'quizId' => $quiz->id]) }}'">
                    {{$quiz->title}}
                </button>
            </div>
        @endforeach
