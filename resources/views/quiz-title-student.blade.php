...
<head>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="{{ asset('student-view/quiz-title-student.css') }}"> <!-- New CSS file for the container -->
</head>
<body>
...
<div class="info-container ">
    ...
    <div class="container-adviser ">
        <div class="container-sm d-flex flex-column justify-content-start align-items-start position-relative p-3 border">
            ...
            <label class="note-time">NOTE: Once you open this, the time for taking this challenge will start already. You only have limited time to take this challenge.</label>
        </div>
    </div>
