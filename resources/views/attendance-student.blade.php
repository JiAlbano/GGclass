...
<head>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="{{ secure_asset('student-view/attendance-student.css') }}"> <!-- New CSS file for the container -->
    <link rel="stylesheet" href="{{ asset('student-view/attendance-student.css') }}"> <!-- New CSS file for the container -->
</head>
<body>
    ...
    <div class="content-container">
        ...
        <div class="class-card">
            ...
            <div class="class-buttons">
                <button class="btn challenge-btn active" onclick="window.location.href='{{ route('attendance-student', ['classId' => $class->id]) }}'">Attendance</button>
