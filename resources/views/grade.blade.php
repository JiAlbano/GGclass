...
<head>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="{{ secure_asset('grade.css') }}"> <!-- New CSS file for the container -->
...
<div class="top-buttons containers" style=" margin-top: 84px;">
    ...
    <div class="info-container ">
        <img src="{{ $user->google_profile_image ?? asset('ainz.jpg') }}" alt="Picture" class="container-picture">
            ...
            <div class="container-buttons">
                ...
                <button class="btn1 challenge-btn1 active"onclick="window.location.href='{{ route('grade', ['classId' => $class->id]) }}'">GRADE</button>
    ...
    <div class="container-q">
        <div class="container quiz-container">
            <button type="button" class="quiz-button" onclick="window.location.href='{{ route('grade-quiz-title', ['classId' => $class->id]) }}'">
                Quiz
            </button>
        </div>
    </div>
