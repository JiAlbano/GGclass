...
<head>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="{{ secure_asset('student-view/profile-student.css') }}"> <!-- New CSS file for the container -->
    <link rel="stylesheet" href="{{ asset('student-view/profile-student.css') }}"> <!-- New CSS file for the container -->
</head>
<body>
