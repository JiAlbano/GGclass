...
<script>
    ...
    <button type="button" class="btn-add2" 
        onclick="window.location.href='{{ route('createexam', ['classId' => $class->id]) }}'">
        Create
    </button>
</div> -->
...
<div class="add-challenge-container">
    <button type="button" class="add-challenge-btn" 
        ...
        <div class="text">Create a new exam for your class</div>
    </button>
</div>
...
<div id="quizModal" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form id="quizForm" method="POST" action="{{ route('exam.store') }}" enctype="multipart/form-data">
                @csrf
