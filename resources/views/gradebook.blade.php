...
<head>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="{{ secure_asset('gradebook.css') }}"> <!-- New CSS file for the container -->
    <link rel="stylesheet" href="{{ asset('gradebook.css') }}"> 
</head>
...
<body>
    ...
    <div class="container-buttons">
        ...
        <button class="btn challenge-btn active"onclick="window.location.href='{{ route('student-list', ['classId' => $class->id]) }}'">GRADEBOOK</button>
    </div>
</div>

<div class="container1">
    <div class="grid-container">
        <button type="button" class="box" onclick="window.location.href='{{ route('grade-components', ['classId' => $class->id]) }}'">
            Grade Component
        </button>
        <button type="button" class="box" onclick="window.location.href='{{ route('data', ['classId' => $class->id]) }}'">
            Data
        </button>
        <button type="button" class="box" onclick="window.location.href='{{ route('class-record', ['classId' => $class->id]) }}'">
            Class Record
        </button>
    </div>
</div>
