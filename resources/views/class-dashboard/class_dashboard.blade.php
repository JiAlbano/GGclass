...
@section('landing')
    ...
    <div class="center-container">
        ...
        <h4>{{ auth()->user()->user_type === 'teacher' ? 'Create a class to get started' : 'Join a class to get started' }}
        </h4>
        ...
        @elseif (auth()->user()->user_type === 'student')
            ...
            <button type="button" id="join-class-option" class="btn btn-success join-class-btn" data-bs-toggle="modal"
