...
@section('landing')
    ...
    <div class="tutorial-container container-sm mt-1 mb-5">
        ...
        <a href="{{ route('tutorials', ['classId' => $class->id]) }}">
        ...
        <div class="tutorial-body">
            <div class="tutorial-content">
                ...
                <form id="tutorial-form" action="{{ route('store-tutorial', $class->id) }}" method="POST"
                    ...
                    <div class="cancel-create">
                        <a href="{{ route('tutorials', $class->id) }}" class="cancel-button btn btn-secondary">Cancel</a>
    ...
    <script>
        ...
        document.getElementById('tutorial-form').addEventListener('submit', function(event) {
            ...
            fetch(this.action, {
                ...
                if (response.ok) {
                    window.location.href = '{{ route('tutorials', $class->id) }}';
                } else {
