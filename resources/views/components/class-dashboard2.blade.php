            ...
            <div class="hyperlink">
                ...
                <div class="bulletins">
                    <button class="btn {{ request()->routeIs('bulletins') ? 'active' : '' }}"
                        onclick="window.location.href='{{ route('bulletins', ['classId' => $class->class_id]) }}'">Bulletins</button>
                </div>

                <div class="tutorials">
                    <button class="btn {{ request()->routeIs('tutorials') ? 'active' : '' }}"
                        onclick="window.location.href='{{ route('tutorials', ['classId' => $class->class_id])}}'">Tutorials</button>
                </div>

                <div class="challenges">
                    <button class="btn {{ request()->routeIs('challenges') ? 'active' : '' }}"
                        onclick="window.location.href='{{ route('challenges', ['classId' => $class->class_id]) }}'">Challenges</button>
                </div>

                <div class="players">
                    <button class="btn {{ request()->routeIs('players') ? 'active' : '' }}"
                        onclick="window.location.href='{{ route('players', ['classId' => $class->class_id]) }}'">Players</button>
                </div>
        ...
        <div class="dashboard-container container-sm mt-5">
            ...
            <div class="left-container">
                ...
                <div class="class-buttons">
                    <button class="btns"
                        onclick="window.location.href='{{ route('attendance', ['classId' => $class->class_id]) }}'">Attendance</button>
                    <!-- <button class="btns"
                        onclick="window.location.href='{{ route('feedback', ['classId' => $class->class_id]) }}'">Feedback</button> -->
